		...
		<div class="py-12">
				<div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
						<div class="flex flex-wrap overflow-hidden bg-white p-5 shadow-xl sm:rounded-lg">
								<div class="w-2/3 p-3">
										<h3 class="mb-3 text-xl font-bold text-gray-800">Meeting List</h3>
												...
												<div class="w-full rounded-lg border border-gray-200">
														<div class="rounded-md bg-white p-5 md:p-8">
																<div class="flex items-center justify-between px-4">
																		<span tabindex="0" class="text-xl font-bold text-gray-800 focus:outline-none">February 2024</span>
						...
						<div class="flex">
								<div class="my-4 mr-2 flex w-1/2 flex-wrap overflow-hidden bg-white p-5 shadow-xl sm:rounded-lg">
										<div class="w-full p-3">
												<h3 class="mb-3 text-xl font-bold text-gray-800">Room management</h3>
												<a href=""
																...
																<div class="inline-block min-w-full p-1.5 align-middle">
																		<div class="overflow-hidden">
																				<table class="min-w-full divide-y divide-gray-200">
																						...
																						<tbody class="divide-y divide-gray-200">
																								<tr>
																										<td class="text-wrap whitespace-nowrap px-6 py-4 text-sm text-gray-800">Ruang Meeting Cafe
																										</td>
																										<td class="text-wrap whitespace-nowrap px-6 py-4 text-sm text-gray-800">Gedung Depan</td>
																										<td class="text-wrap whitespace-nowrap px-6 py-4 text-sm text-gray-800">6</td>
																										<td class="text-wrap whitespace-nowrap px-6 py-4 text-sm"><a href=""
																														class="font-bold text-blue-500 hover:text-blue-800">Edit</a></td>
																								</tr>

																								<tr>
																										<td class="text-wrap whitespace-nowrap px-6 py-4 text-sm text-gray-800">Ruang Meeting Baru
																										</td>
																										<td class="text-wrap whitespace-nowrap px-6 py-4 text-sm text-gray-800">Gedung Depan</td>
																										<td class="text-wrap whitespace-nowrap px-6 py-4 text-sm text-gray-800">8</td>
																										<td class="text-wrap whitespace-nowrap px-6 py-4 text-sm"><a href=""
																														class="font-bold text-blue-500 hover:text-blue-800">Edit</a></td>
																								</tr>
																								...
																								<tr>
																										...
																										<td class="text-wrap whitespace-nowrap px-6 py-4 text-sm text-gray-800">Gedung Depan</td>
																										<td class="text-wrap whitespace-nowrap px-6 py-4 text-sm text-gray-800">10</td>
																										<td class="text-wrap whitespace-nowrap px-6 py-4 text-sm"><a href=""
																														class="font-bold text-blue-500 hover:text-blue-800">Edit</a></td>
																								</tr>

																								<tr>
																										<td class="text-wrap whitespace-nowrap px-6 py-4 text-sm text-gray-800">Ruang Meeting Utama
																										</td>
																										<td class="text-wrap whitespace-nowrap px-6 py-4 text-sm text-gray-800">Gedung Depan</td>
																										<td class="text-wrap whitespace-nowrap px-6 py-4 text-sm text-gray-800">10</td>
																										<td class="text-wrap whitespace-nowrap px-6 py-4 text-sm"><a href=""
								...
								<div class="my-4 ml-2 flex w-1/2 flex-wrap overflow-hidden bg-white p-5 shadow-xl sm:rounded-lg">
										<div class="w-full p-3">
												<h3 class="mb-3 text-xl font-bold text-gray-800">Role access management</h3>
												<a href=""
														class="rounded-md bg-primary px-2.5 py-1.5 text-white transition duration-300 hover:bg-blue-900">Add
														role
														<span class="ml-1 text-lg font-bold">+</span></a>
												<div class="mt-5 flex flex-col">
														<div class="-m-1.5 overflow-x-auto">
																<div class="inline-block min-w-full p-1.5 align-middle">
																		<div class="overflow-hidden">
																				<table class="min-w-full divide-y divide-gray-200">
																						...
																						<tbody class="divide-y divide-gray-200">
																								<tr>
																										<td class="text-wrap whitespace-nowrap px-6 py-4 text-sm text-gray-800">Admin
																										</td>
																										<td class="text-wrap whitespace-nowrap px-6 py-4 text-sm text-gray-800">1</td>
																								...
																								<tr>
																										<td class="text-wrap whitespace-nowrap px-6 py-4 text-sm text-gray-800">User
																										</td>
																										<td class="text-wrap whitespace-nowrap px-6 py-4 text-sm text-gray-800">20</td>
																										<td class="text-wrap flex gap-x-4 whitespace-nowrap px-6 py-4 text-sm"><a href=""
																														class="font-bold text-blue-500 hover:text-blue-800">Edit</a><a href=""
																														class="font-bold text-red-500 hover:text-red-800">Delete</a></td>
																								</tr>
