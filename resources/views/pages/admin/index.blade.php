		...
		<div class="py-12">
				<div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
						...
						<div class="flex flex-col lg:flex-row">
								<div class="mb-4 mr-2 flex w-full flex-wrap overflow-hidden bg-white p-5 shadow-xl sm:rounded-lg lg:w-1/2">
										<div class="w-full p-3">
								...
								<div class="mb-4 ml-2 flex w-full flex-wrap overflow-hidden bg-white p-5 shadow-xl sm:rounded-lg lg:w-1/2">
										<div class="w-full p-3">
